                ...
                <div key={user._id} className="cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group">
                    <div className="flex items-start gap-3">
                        <div className="relative">
                            <Avatar className="size-8 border-l-zinc-800">
                                <AvatarImage  
                                src={user.imageUrl}
                                alt={user.fullName}
                                />
                            ...
                            <div
                            className={`absolute bottom-0 right-0 h-3 w-3 rounded-full border-2 border-l-zinc-900 bg-zinc-500`}
                            aria-hidden='true'
                            />
                        </div>
                        <div className="flex-1 minw-0" >
                            ...
                            {isPlaying ? (  
                                <div className="mt-1" >
                                    ...
                                    <div className="text-xs text-zinc-400 truncate">by Arctic Monkeys</div>
                                </div>
                            ):(
